...
class MainControl(Document):
	...
	def open_door_1(self):
		delay = get_delay('open_door_1_delay')
		change_address_1_0(DOOR_1_OPEN_PB, delay)

	def open_door_2(self):
		delay = get_delay('open_door_2_delay')
		change_address_1_0(DOOR_2_OPEN_PB, delay)

	def close_door_1(self):
		delay = get_delay('close_door_1_delay')
		change_address_1_0(DOOR_1_CLOSE_PB, delay)

	def close_door_2(self):
		delay = get_delay('close_door_2_delay')
		change_address_1_0(DOOR_2_CLOSE_PB, delay)
